...
ActiveRecord::Schema.define(version: 2021_11_13_074524) do
  ...
  create_table "category_quizzes", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "category_id", null: false
    t.bigint "quiz_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["category_id"], name: "index_category_quizzes_on_category_id"
    t.index ["quiz_id"], name: "index_category_quizzes_on_quiz_id"
  end
  ...
  add_foreign_key "category_quizzes", "categories"
  add_foreign_key "category_quizzes", "quizzes"
